...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        AreaAggregatorOutputter stringOutputter = new AreaAggregatorOutputter(aggregator);
        ...
        AreaAggregatorOutputter cityStringOutputter = new AreaAggregatorOutputter(city);
